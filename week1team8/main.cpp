...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	//ACollider* NewBall = SpawnColider<ACollider>(FVector(0, 0, 0), EPrimitive::Circle, true, { 0.1, 0.1, 1 });
	// ACollider* ball = SpawnColider<ACollider>(FVector(0, 0, 0), EPrimitive::Circle, true, { 1, 1, 1 });
	ACollider* rec = SpawnColider<ACollider>(FVector(0, 0, 0), EPrimitive::Rectangle, true, { 1, 1, 1 });
